...
- Браузерные тесты: `.\serve.ps1` → `http://localhost:3000/tests/smoke.html` (10/10),
  ...
  `http://localhost:3000/tests/audioInput-test.html` (11/11, только с флагами `--use-fake-device-for-media-stream --use-fake-ui-for-media-stream`),
  `http://localhost:3000/tests/wavExport-test.html` (8/8) и
  `http://localhost:3000/tests/arranger-test.html` (217/217) — без FAIL (итого 660/660).
